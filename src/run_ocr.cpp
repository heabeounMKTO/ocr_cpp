...
main(int argc, char* argv[])
{
  ...
  std::shared_ptr<paddle_infer::Predictor> paddle_rec = new_paddle_recognizer(
    ...
    4,
    false,
    "/media/hbdesk/hb_desk_ext/ocr_core/models/kh_dict.txt",
    false,
    "f32",
    1,
    112,
  ...
  auto images = crop_detections(image, results, false);
  run_rec_model(paddle_rec, images);
