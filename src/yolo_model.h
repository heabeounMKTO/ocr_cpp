...
// using the YOLOv12 model. It includes necessary libraries, utility structures,
// and helper functions to facilitate model inference and result postprocessing.
//
// Authors:
